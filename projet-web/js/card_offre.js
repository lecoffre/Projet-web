...
// Fonction afficher offre
 ...
 { 
     ...
     xhr.open("GET", "api/offre/lire_offre.php", true);
     xhr.onload = function()
     {
         var html = '';
         if( xhr.status == 200 )
...
function afficher_une_offre(id_offre){
    ...
    xhr.open("POST", "api/offre/lire_une_offre.php", true);
...
function modifier_offre(id_offre){
    ...
    if(true){
        ...
        xhr.open("PUT", "api/offre/modifier_offre.php", true);
...
function supprimer_offre(id){
    ...
    if(true){
        ...
        xhr.open("DELETE", "api/offre/supprimer_offre.php", true);
