...
{ 
    ...
    xhr.open("GET", "/api/delegue/lire_delegue.php", true);
    xhr.onload = function()
    {
         var html = '';
         if( xhr.status == 200 )
...
function afficher_un_delegue(id_delegue){
    ...
    xhr.open("POST", "/api/delegue/lire_un_delegue.php", true);
...
function supprimer_delegue(id){
    ...
    if(true){
        ...
        xhr.open("DELETE", "api/suppression/suppression_delegue.php", true);
