...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        $donnees->Centre_etudiant;
        $donnees->Promotion_etudiant;
        $donnees->Specialite;
        $donnees->Nom;
        $donnees->Prenom;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            switch (true) {
                case ((!empty($donnees->Centre_etudiant) and !empty($donnees->Promotion_etudiant) and !empty($donnees->Specialite) and !empty($donnees->Nom) and !empty($donnees->Prenom)) and
                    $donnees->Centre_etudiant == $etud['Centre_etudiant'] and
                    $donnees->Promotion_etudiant == $etud['Promotion_etudiant'] and
                    $donnees->Specialite == $etud['Specialite'] and
                    $donnees->Nom == $etud['Nom'] and
                    $donnees->Prenom == $etud['Prenom']):
                ...
                case ((empty($donnees->Centre_etudiant) and empty($donnees->Promotion_etudiant) and empty($donnees->Specialite) and empty($donnees->Nom) and !empty($donnees->Prenom)) and
                    ...
                    $tableauEtudiant['etudiant'][] = $etud;
                    break;
                case ((empty($donnees->Centre_etudiant) and empty($donnees->Promotion_etudiant) and empty($donnees->Specialite) and empty($donnees->Nom) and empty($donnees->Prenom))):
                    $tableauEtudiant['etudiant'][] = $etud;
                    break;
            }
        }
