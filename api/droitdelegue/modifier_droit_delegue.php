...
if ($_SERVER['REQUEST_METHOD'] == 'PUT') {
    ...
    if (
        !empty($donnees->ID_Utilisateur) && !empty($donnees->ID_Utilisateur__Assigne_DROIT) && !empty($donnees->Creer_une_offre) && !empty($donnees->Modifier_une_offre) && !empty($donnees->Supprimer_une_offre) && !empty($donnees->Rechercher_un_compte_delegue) && !empty($donnees->Creer_un_delegue) && !empty($donnees->Modifier_un_compte_delegue) && !empty($donnees->Supprimer_un_compte_delegue) && !empty($donnees->Rechercher_un_compte_etudiant) && !empty($donnees->Creer_un_etudiant) && !empty($donnees->Modifier_un_etudiant) && !empty($donnees->Supprimer_un_etudiant) && !empty($donnees->Consulter_les_stats_des_etudiants) && !empty($donnees->Informer_le_systeme_de_l_avancement_de_la_candidature_step_3) && !empty($donnees->Informer_le_systeme_de_l_avancement_de_la_candidature_step_4)) {
        ...
        if ($droitdelegue->modifier_droit_delegue()) {
