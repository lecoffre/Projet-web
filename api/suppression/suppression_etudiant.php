...
if ($_SERVER['REQUEST_METHOD'] == 'DELETE') {
    ...
    if (!empty($donnees->ID_Login)) {
        ...
        if ($utilisateur->Nom != null) {
            ...
            if ($suppression->supprimer_candidature() && $suppression->supprimer_etudiant() && $suppression->supprimer_droit() && $suppression->supprimer_utilisateur() && $suppression->supprimer_authentification()) {
