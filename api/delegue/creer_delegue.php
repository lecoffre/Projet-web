...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($donnees->ID_Utilisateur) && !empty($donnees->Centre_Delegue) && !empty($donnees->Promotion_delegue) && !empty($donnees->ID_Utilisateur__CREE) && !empty($donnees->ID_Login)) {
